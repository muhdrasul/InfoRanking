            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <i class="fa fa-table"></i> All Data</div>
                    <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="btn-info" type="button" name="edit" value="Edit"  onclick="editRecord(<%=myResultSet.getString(4)%>);"/>
                                                <input type="button" name="delete" class="btn-danger" value="Delete" onclick="deleteRecord(<%=myResultSet.getString(4)%>);" >
                                            </td>
                                        </tr>
                                    <% } %>
                                    <%
                     ...
                     <form onsubmit="return confirmSMS()" action="alldata.htm" method="POST"> 
