  ...
  <link href="css/sb-admin.css" rel="stylesheet">
     <script language="javascript">
            function editRecord(date) {
                var f = document.form;
                f.method = "post";
                f.action = 'tabledate.htm?id=' + date;
                f.submit();
            }
            function deleteRecord(id){
                var f=document.form;
                f.method="post";
                f.action='delete.htm?id='+id;
                f.submit();
            }
        </script>
                ...
                %>
                  ...
                  <div class="card mb-3">
                    <div class="card-header">
                      <i class="fa fa-table"></i> Top Website by Selected Date</div>
                    <div class="card-body">
                        <form action="tableweek.htm" method="POST">
                      <div class="container">
                         <h4>Rank Website by Selected Date</h4> 
                         <select class="form-control" name="date" onchange="this.form.submit();">
                                            <option value="0">Select date:</option>
                                        <%  while(myResultSet1.next()){ %>
                                        <option  value="<%= myResultSet1.getString(1)%>">
                                            <%= myResultSet1.getString(1)%></option>
                                    ...
                                    %></b>
                                            ...
                                            try {
                                                ...
                                                String myDataField = null;
                                                //String myQuery = "SELECT "+'"'+"Date"+'"'+","+'"'+"Website"+'"'+","+'"'+"Visits"+'"'+",row_number() over(order by "+'"'+"Visits"+'"'+" DESC) from data limit 5";
                                                String myQuery = "Select *,row_number() over(order by "+'"'+"Visits"+'"'+" Desc) from data where "+'"'+"Date"+'"'+"='"+request.getParameter("date")+"' limit 5";
                                               // System.out.println(myQuery);
                                                Connection myConnection = null;
                                               PreparedStatement myPreparedStatement = null;
                                                //PreparedStatement myPreparedStatement1 = null;
                                        ...
                                        {
                                              out.println("Result for Date: "+ request.getParameter("date"));
                                        }
                                        %>
                                            </b></center>
                                     </font>
                     ...
                     <div class="table-responsive">
                         <form  action="tabledate.htm" method="POST" onsubmit="return confirmSMS()"> 
                                    ...
                                    <% 
                                     ...
                                     <% 
                                          ...
                                          %>
                                    <input type="hidden" name="id" value="<%=dt%>"/>
                             <center><input class="btn-info" type="submit" value="Generate PDF Report" /> Note: Pdf file generate at C:/ directory  </center>  
