...
<%@ page import="java.io.*" %>
  <%
                                            try {
                                               ...
                                               String myQuery = "Select *,row_number() over(order by "+'"'+"Visits"+'"'+" Desc) from data where "+'"'+"Date"+'"'+"='"+request.getParameter("id")+"' limit 5";
                                               ...
                                               PreparedStatement myPreparedStatement = null;
                                                ...
                                                PdfWriter.getInstance(document,new FileOutputStream("C:/Ranking by date.pdf"));
                                                document.open();
                                       ...
                                       table.addCell(myResultSet.getString(2));
                                        ...
                                        response.sendRedirect("/WebRanking/tableweek.htm");
                                    } catch (Exception ex) {
                                        ex.printStackTrace();
                                    %>
